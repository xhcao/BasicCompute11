...
HRESULT CreateTexture2D(_In_ ID3D11Device* pDevice, _In_ UINT xDimension, _In_ UINT yDimension, bool readonly, _In_ UINT16* initialData, _Outptr_ ID3D11Texture2D** pTexture2D);
...
UINT16* matrixC = nullptr;
UINT16* matrixReference = nullptr;
...
int __cdecl main()
{
	...
	matrixA = new UINT16[NUM_ELEMENTS];
	matrixB = new UINT16[NUM_ELEMENTS];
	matrixC = new UINT16[NUM_ELEMENTS];
	matrixReference = new UINT16[NUM_ELEMENTS];
...
HRESULT CreateTexture2D(_In_ ID3D11Device* pDevice, _In_ UINT xDimension, _In_ UINT yDimension, bool readonly, _In_ UINT16* initialData, _Outptr_ ID3D11Texture2D** pTexture2D)
{
	...
	Tex2DDesc.Format = DXGI_FORMAT_R16_UINT;
